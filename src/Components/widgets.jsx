...
function widgets(){
        ...
        <div className="widgets_inputs">
            <span className="material-symbols-outlined widgets_searchIcon" style={{backgroundColor: 'transparent'}}>search</span>
        ...
        <div className="trends" >
            ...
            <div className="showmore" style={{backgroundColor: 'transparent'}}>
                <p style={{backgroundColor: 'transparent'}}>Show More</p>
            </div>
            </div>
